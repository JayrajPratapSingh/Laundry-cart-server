...
//Mongoose connection
const DB = "mongodb+srv://jairajPratapSingh:Jai12345@cluster0.xyb0juy.mongodb.net/Laundary_cart?retryWrites=true&w=majority"
// mongodb+srv://Muralidhar:Murali4143@cluster0.4sn98qh.mongodb.net/Laundry_Cart?retryWrites=true&w=majority
mongoose.connect(DB)
.then(() =>{
...
app.post("/login", async (request, response) =>{
    try{
        ...
        jwt.sign(userPayload,"10xLaundrycart",{expiresIn:600000},(error, Token)=>{
            if(error){
                console.log(error)
...
let PORT = process.env.PORT || 4143
app.listen(PORT, () => {
